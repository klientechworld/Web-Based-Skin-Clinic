...
<body>
    ...
    $sqlmain = "select *, a.appoid as appointment_number FROM 
    appointment a INNER JOIN schedule s ON s.scheduleid = a.scheduleid 
                                    ...
                                    <br><br><br><br>
                                        ...
                                        for ($x = 0; $x < ($result->num_rows); $x++) {
                                            ...
                                            for ($q = 0; $q < 3; $q++) {
                                                ...
                                                $appoid = $row["appointment_number"];
                                                $date_created = $row["date_created"];
                                                $reference = $row['reference'];
                                                $time = $row['time_selected'];
                                                if ($scheduleid == "") {
                                                    break;
                                                }
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div style="width:100%;">
                                                        <div class="h3-search">
                                                        Booking Date: ' . date('F d, Y h:i A', strtotime($date_created)) . '<br>
                                                                    Reference Number: ' . $reference . '
                                                                </div>
                                                        <div class="h3-search">
                                                                    Date of Session: ' . date('F d, Y', strtotime($appodate)) . '<br>
                                                                    Reference Number: ' . $reference . '
                                                                </div>
                                                                <div class="h3-search">
                                                                    Time of Session: ' . date('h:i A', strtotime($time)) . '<br>
                                                                </div>
                                                                <div class="h3-search">
                                                                    Price: ' . $price . '<br>
