...
<body>
                    ...
                    <td style="padding:10px" colspan="2">
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <img src="../img/fermosa-jpeg.jpg" alt="" width="100%" style="border-radius:50%">                                </td>
        ...
        <tr class="menu-row">
            <td class="menu-btn menu-icon-doctor ">
                <a href="doctors.php" class="non-style-link-menu ">
                    <div>
                        <p class="menu-text">Technician</p>
                </a>
    </div>
    </td>
    </tr>
    ...
    <tr class="menu-row">
        <td class="menu-btn menu-icon-patient">
            <a href="patient.php" class="non-style-link-menu">
                <div>
                    <p class="menu-text">Customer Lists</p>
            </a></div>
        </td>
    </tr>
    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            ...
            if ($_POST) {
                ...
                $sqlmain = "select * FROM schedule  order by scheduledate desc";
            }
                        ...
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $sqlmainfetch = "SELECT * FROM appointment a 
                                    INNER JOIN schedule s ON s.scheduleid = a.scheduleid 
                                    INNER JOIN doctor d ON d.docid = a.doctor_id
                                    
                                     ";

                                    $result = $database->query($sqlmainfetch);
                                    ...
                                    <br><br><br><br>
                                        ...
                                        for ($x = 0; $x < $result->num_rows; $x++) {
                                            ...
                                            $selectedDoctor = $row['docname'];
                                            $scheduledate = $row["appodate"];
                                            $scheduletime = $row["time_selected"];
                                            $nop = $row["nop"];
                                            echo
                                            '<tr>
                                                <td> &nbsp;' .
                                                ...
                                                <td style="text-align:center;">
                                                    ' . $scheduledate . ' ' . substr($scheduletime, 0, 5) . '
                                                </td>
                                                <td style="text-align:center;">
                                                    ' . $nop . '
                                                </td>
    ...
    if ($_GET) {
        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                ...
                . '</td>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Price of Service: </label>
                                </td>
                            </tr>
                            <tr>
            ...
            $sqlmain = "select * from appointment a 
            INNER JOIN  schedule s ON s.scheduleid = a.scheduleid 
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                ' . date('h:i A', strtotime($scheduletime)) . '<br><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
