                                ...
                                <tbody>
                                    ...
                                    <br><br><br><br>
                                        ...
                                        <td style="text-align:center;">
                                            ' . $appodate . ' ' . date('h:i A', strtotime($scheduletime)) . '
                                        </td>
    ...
    if ($_GET) {
        ...
        if ($action == 'add-session') {
            ...
            echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nop" class="form-label">Number of SKIN-CLINIC/Appointment Numbers : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
