            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="doctors.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Technician</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-customer">
                        <a href="patient.php" class="non-style-link-menu"><div><p class="menu-text">Customer Lists</p></a></div>
                    </td>
                </tr>
